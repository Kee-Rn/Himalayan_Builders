            ...
            <div class="flex-1 min-w-0">
                <div class="eco-card relative rounded-[20px] overflow-hidden" style="height: 440px;">
                    ...
                    <div class="absolute top-8 left-8">
                        <div id="eco-card-logo" class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col leading-tight">
                                <span class="font-body font text-[22px] text-[#C0392B] leading-none">{{ $companies[0]['logoLine1'] ?? 'Himalayan' }}</span>
                                <span class="font-body font text-[22px] text-white leading-none">{{ $companies[0]['logoLine2'] ?? 'Brick' }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-8">
                        <h3 id="eco-card-title" class="font-body text-white font text-[28px] leading-[1.1] m-0 mb-3">
